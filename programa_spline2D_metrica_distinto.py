...
for i in range(1, len(x)):
    ...
    p = input(f"Indica el orden p de la métrica a utilizar para el {i}º intervalo (1, 2, ..., inf): ")
...
plt.xlabel("x")
plt.ylabel("y")
plt.title("Interpolación con Spline Cúbico con norma distinta en cada intervalo")
plt.legend()
plt.grid(True)
plt.show()
